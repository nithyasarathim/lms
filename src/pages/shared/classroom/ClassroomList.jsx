...
import { getClassrooms } from '../../faculty/api/faculty.api';

const ShimmerCard = () => (
  <div className="relative flex flex-col h-50 overflow-hidden rounded-2xl animate-pulse">
    <div
      className="absolute inset-0 bg-linear-to-r opacity-40 from-gray-200 via-gray-300 to-gray-200 animate-shimmer"
...
const ClassroomList = ({ onSelectClassroom }) => {
        ...
        {loading
          ...
          : classrooms.map((item, index) => {
              ...
              return (
                <div
                  key={item?._id}
                  onClick={() => onSelectClassroom?.(item._id)}
