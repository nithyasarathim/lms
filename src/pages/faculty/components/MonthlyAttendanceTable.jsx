        ...
        <table className="w-full border-collapse text-left">
          ...
          <tbody className="text-xs">
            {data.length ? (
              data.map((item, index) => (
                <tr
                  key={item.attendanceId || item.monthValue || `${item.date}-${index}`}
                ...
                >
                  {isSemesterView ? (
                    <>
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="h-1.5 w-48 rounded-full bg-gray-100">
                            <div
                    ...
                    <>
                      <td className="p-4 font-medium text-[#08384F]">{item.date}</td>
                      <td className="p-4">{item.classHour}</td>
                      <td className="p-4 text-center">{item.totalStudents}</td>
