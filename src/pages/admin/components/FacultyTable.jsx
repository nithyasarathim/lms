            ...
            {loading ? (
              <tr>
                <td colSpan="5" className="py-20 text-center">
                  <Loader2 className="animate-spin mx-auto text-[#08384F]" />
                </td>
              </tr>
            ) : (
              filteredFaculties.map((faculty) => (
                <tr
                  key={faculty._id}
                  className={`hover:bg-gray-50/50 transition-colors ${!faculty.isActive && "opacity-60 bg-gray-50/40"}`}
                >
                  ...
                  <td className="px-4 py-4 text-xs">{faculty.designation}</td>
